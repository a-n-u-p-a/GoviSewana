...
const Account = () => {
    ...
    async function fetchData() {
        try {
            let url = 'https://govisewana-production.up.railway.app/userProfile/getUserData/';
    ...
    function handleButtonClick() {
        ...
        async function postUpdateData() {
            try {
                let url = 'https://govisewana-production.up.railway.app/userProfile/updateUserData/';
                let response = await fetch(url, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
